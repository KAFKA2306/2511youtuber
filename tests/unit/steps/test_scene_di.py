...
from src.services.image_generation import ImageGenerationRequest, ImageGenerationResult
...
def test_scene_generator_dependency_injection():
    ...
    # Act
    try:
        # This should fail if DI is not strictly enforced (i.e. if it tries to
        # instantiate ZImageTurboService internally when None is passed, or if we
        # want to enforce passing it)
